...
import de.spanier.microcar.ui.home.HomeFragment
...
//            transaction.commit()
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
                R.id.nav_home, R.id.control_ui, R.id.nav_gallery, R.id.nav_slideshow), drawerLayout)
        // R.id.nav_home,
